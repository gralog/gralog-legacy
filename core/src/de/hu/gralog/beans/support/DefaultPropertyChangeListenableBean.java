...
/**
 * This class is a helper class to implement the {@link PropertyChangeListenable}
 * interface. It administers the listeners and provides methods
 * to fire {@link PropertyChangeEvent PropertyChangeEvents}. You
 * should subclass this class to define a Bean that allows others
 * to listen to changes of its properties.
 * 
 * @author Sebastian
 *
 */
