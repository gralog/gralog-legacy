...
public class DisplayChangeSupport<V,E> implements DisplayChangeListenable<V,E> {
	...
	public void fireDisplayChange( Set<V> vertices, Set<E> edges, boolean wholeGraph ) {
