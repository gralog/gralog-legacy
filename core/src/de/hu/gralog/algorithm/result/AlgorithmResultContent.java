...
public class AlgorithmResultContent {
	 ...
	 */
	public AlgorithmResultContent( GralogGraph graph ) {
		setGraph( graph );
	}
	 ...
	 * @param graph the graph which should be displayed with this content
	 */
	public void setGraph( GralogGraph graph ) {
		this.graph = graph;
	}
	 ...
	 */
	public GralogGraph getGraph() throws UserException {
		return graph;
	}
	...
	protected Hashtable<String, ElementTips> getElementTips( Hashtable<String, ElementTipsDisplayMode> modes ) throws UserException {
		if ( elementTips == null )
			return null;
