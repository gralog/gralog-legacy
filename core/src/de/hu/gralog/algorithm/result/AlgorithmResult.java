 ...
 * to do is to define a {@link de.hu.gralog.algorithm.result.DisplaySubgraphMode} and
...
public class AlgorithmResult implements Serializable {
	...
	protected GralogGraph graph = null;
	 ...
	 * @param graph
	 */
	public AlgorithmResult( GralogGraph graph ) {
		this.graph = graph;
	}
	 ...
	 */
	public GralogGraph getGraph() {
		return graph;
	}
	
	GralogGraph getGraph( AlgorithmResultContent content ) throws UserException {
	...
	Hashtable<String, ElementTips> getElementTips( AlgorithmResultContent content ) throws UserException {
		return content.getElementTips( elementTipsModes );
	}
	
	Hashtable<String, DisplaySubgraph> getDisplaySubgraphs( AlgorithmResultContent content ) throws UserException {
	...
	Set<GralogGraph> getAllGraphs() throws UserException {
	...
	Set<GralogGraph> getAllGraphsFromContents() throws UserException {
		HashSet<GralogGraph> graphs = new HashSet<GralogGraph>();
