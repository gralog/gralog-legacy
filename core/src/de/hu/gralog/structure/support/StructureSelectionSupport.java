 ...
 * Plugin-developers might use this class if they want to implement an
 * {@link de.hu.gralog.algorithm.result.AlgorithmResultInteractiveContent} and
 * listen to it's SelectionChangeEvents.
 * 
 * @see de.hu.gralog.structure.Structure#getStructureSelectionSupport()
 * 
 * @author Sebastian
 * 
 * @param V
 ...
 *            the edgeType
 */
public class StructureSelectionSupport<V, E> implements GraphSelectionListener {
	 ...
	 * GrALoG-Structure this instance belongs to.
	 * 
	 * @param l
	 */
