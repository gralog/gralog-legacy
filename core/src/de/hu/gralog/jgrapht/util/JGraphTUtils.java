...
public class JGraphTUtils {
	...
	/**
	 * This method returns the JGraphT-Graph that is wrapped by
	 * a {@link ListenableGraph}. It can be useful for Plugin-Developers
	 * in order to infer the reall JGraphT-Type of this Graph, i.e.
	 * wether the Graph is Simple, Multi, Pseudo etc. . 
	 *  
	...
	public static <V, E, G extends Graph<V, E>> G getListenableBaseGraph(
		...
		if (!(graph instanceof GraphDelegator))
			return null;
		return getDelegate((GraphDelegator<V, E>) graph);
	}
