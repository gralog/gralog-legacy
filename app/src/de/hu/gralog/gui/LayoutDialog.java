 ...
 *
 * Copyright (C) 2003 Gaudenz Alder, Copyright 2006 Sebastian Ordyniak (sordyniak@googlemail.com) and Stephan Kreutzer (kreutzer.stephan@googlemail.com)
 *
...
import de.hu.gralog.layout.JGraphLayoutAlgorithm;
import de.hu.gralog.layout.JGraphLayoutRegistry;
import de.hu.gralog.layout.JGraphLayoutSettings;
import de.hu.gralog.resources.Translator;
    		...
    		Thread t = new Thread("Layout Algorithm " + controller.toString()) {
    			public void run() {
    				try {
    					...
    					MainPad.getInstance().handleUserException( new UserException( "error executing layoutalgorithm", t ) );
    				} finally {
