 ...
 *
 * Copyright (C) 2001 Gaudenz Alder, Copyright 2006 Sebastian Ordyniak (sordyniak@googlemail.com) and Stephan Kreutzer (kreutzer.stephan@googlemail.com)
 *
...
public class OverviewPanel
	 ...
	 */
	protected OverviewPanel(JGraph g) {
		originalGraph = g;
	...
	public static JPanel createOverviewPanel(JGraph g){
		...
		panelWithInternalOffset.add(new OverviewPanel( g ), BorderLayout.CENTER);
	...
	class PannerViewfinder
		...
		public PannerViewfinder(Container c, JViewport viewport) {
			this.container = c;
