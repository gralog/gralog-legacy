...
public class Plugin {
	...
	public class AlgorithmInfo {
		...
		public AlgorithmInfo(String name, Class<? extends Algorithm> type)
		...
		void loadAlgorithm() throws UserException {
			...
			try {
				description = Introspector.getBeanInfo(type)
	...
	public Plugin(File file) throws UserException {
		LOGGER.debug("entering contructor with file: {}", file);
		try {
			if (!file.exists())
	...
	protected void loadSettings(InputStream in) throws JDOMException,
	...
	protected void loadGraphSettings(Element graph) throws UserException {
		...
		try {
			structureTypeClasses.add((Class<StructureTypeInfo>) MainPad
	...
	protected void loadAlgorithmsSettings(Element algorithms)
			throws UserException {
		for (Element child : (List<Element>) algorithms.getChildren())
			loadAlgorithmSettings(child);
	}

	protected void loadAlgorithmSettings(Element algorithm)
			throws UserException {
		...
		try {
			Class<? extends Algorithm> type = (Class<? extends Algorithm>) MainPad
