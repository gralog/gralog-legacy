...
import de.hu.gralog.graph.types.ParityGameVertex;
...
import de.hu.gralog.jgrapht.traverse.vertexfilters.PlayerVertexFilter;
...
public class StrategyImprovementAlgorithm<V extends ParityGameVertex,E extends DefaultEdge> extends Algorithm {
	...
	protected AlgorithmResultContent getContent( Strategy<V,E> strategyPlayer0, Strategy<V,E> strategyPlayer1, Valuation valuation ) {
		...
		if ( valuation != null ) {
			content.addElementTips( this.ETM_VALUATION, valuation.function );
	...
	private static class PlayProfile<V> {
