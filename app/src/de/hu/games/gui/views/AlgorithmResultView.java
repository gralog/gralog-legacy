...
import de.hu.games.graph.alg.AlgorithmResultInfo;
import de.hu.games.graph.alg.AlgorithmResultInteractiveContent;
import de.hu.games.graph.io.XMLDecoderIO;
import de.hu.games.gui.HTMLEditorPane;
import de.hu.games.gui.MainPad;
import de.hu.games.gui.document.AlgorithmResultDocumentContent;
import de.hu.games.gui.document.Document;
import de.hu.games.gui.document.DocumentListener;
import de.hu.games.jgrapht.graph.DisplaySubgraphModeListener;
import de.hu.games.jgrapht.graph.ElementTipsDisplayModeListener;
