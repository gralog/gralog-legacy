...
public class RandomParityGameGraphGeneratorAlgorithm extends Algorithm {
...
//		new RandomGraphGenerator( CONFIGURATION.getSize(), CONFIGURATION.getEdgePropability() ).generateGraph( graph, new RandomParityGameVertexFactory( graph, CONFIGURATION.getPlayer0Propability() ), null );
//		
...
//		}
	...
	public static class Configuration {
		...
		private double player0Propability;
		
		public Configuration( int size, double edgePropability, double player0Propability ) {
			this.size = size;
			this.edgePropability = edgePropability;
			this.player0Propability = player0Propability;
		}
		...
		public double getPlayer0Propability() {
			return player0Propability;
		}

		public void setPlayer0Propability(double player0Propability) {
			this.player0Propability = player0Propability;
		}
	}
