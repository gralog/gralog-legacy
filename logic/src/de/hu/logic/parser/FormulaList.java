...
public class FormulaList 
{
	...
	public FormulaList(String type)
	{	
		_map = new HashMap<String,Formula>();
		_type = type;
	}
	...
	public void addAll(FormulaList fl) throws ParseException
	{
...
//			throw new ParseException(ParseException.SUBST_UNKNOWN_FORMULA, "The formula " + name + "can not be found for substitution.");
		...
		case Formula.diamond: return new Formula(Formula.diamond, f.ident(), substitute(f.subf()));
		case Formula.box: return new Formula(Formula.box, f.ident(), substitute(f.subf()));
		case Formula.mu: return new Formula(Formula.mu, f.ident(), substitute(f.subf()));
		case Formula.nu: return new Formula(Formula.nu, f.ident(), substitute(f.subf()));
		case Formula.sub:
