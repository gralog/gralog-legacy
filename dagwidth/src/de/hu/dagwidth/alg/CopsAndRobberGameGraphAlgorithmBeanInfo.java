...
public class CopsAndRobberGameGraphAlgorithmBeanInfo extends SimpleBeanInfo {
	...
	private static final BeanDescriptor BEAN_DESCRIPTOR = new BeanDescriptor( CopsAndRobberGameGraphAlgorithm.class );
	...
	static {
		...
		try {
			PROPERTY_DESCRIPTORS[0] = new ChooseStructurePropertyDescriptor( "graph", CopsAndRobberGameGraphAlgorithm.class, new LabeledSimpleDirectedGraphStructureTypeInfo() );
			...
			PROPERTY_DESCRIPTORS[2] = new PropertyDescriptor( "robberMonotone", CopsAndRobberGameGraphAlgorithm.class );
			PROPERTY_DESCRIPTORS[2].setShortDescription( "<html>If <b>true</b> the cops are restricted to make robbermonotone moves.</html>" );

			PROPERTY_DESCRIPTORS[3] = new PropertyDescriptor( "copMonotone", CopsAndRobberGameGraphAlgorithm.class );
